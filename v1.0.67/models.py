...
class FanCircle(Base):
    ...
    fans = relationship("StarFan", back_populates="fan_circle", cascade="all, delete-orphan")
    committee_members = relationship("DisciplineCommittee", back_populates="fan_circle", cascade="all, delete-orphan")
    checkins = relationship("FanCheckIn", back_populates="fan_circle", cascade="all, delete-orphan")
